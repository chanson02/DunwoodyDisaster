...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.imgDict = {'sword': QPixmap(self.imageDir + 'sword.jpg'),
        ...
        row = 0
        colm = 0
        self.mainLayout.addItem(QSpacerItem(30, 50, QSizePolicy.Fixed, QSizePolicy.Fixed), row, 0)
        row += 1
        colm += 1
        ...
        self.P1WeaponWgt.setStyleSheet('border-left: 1px solid green; min-width: 125px;')
        ...
        self.P1WeaponLayout.addItem(QSpacerItem(0, 30, QSizePolicy.Fixed, QSizePolicy.Fixed), arsRow, 1)
        arsRow += 1
        ...
        for key in self.P1WeaponArray:
            ...
            self.P1WeaponLayout.addItem(QSpacerItem(0, 10, QSizePolicy.Fixed, QSizePolicy.Fixed), arsRow, 1)
            arsRow += 1
            ...
            self.P1_weapon1_Lbl3 = QLabel('H: ' + str(self.P1WeaponArray[key][0]) + '\nM: ' + str(self.P1WeaponArray[key][1]) + '\nMech: ' + str(self.P1WeaponArray[key][2]))
            ...
            self.P1WeaponLayout.addItem(QSpacerItem(0, 40, QSizePolicy.Fixed, QSizePolicy.Fixed), arsRow, 1)
            arsRow += 1
        self.P1WeaponLayout.addItem(QSpacerItem(0, 40, QSizePolicy.Fixed, QSizePolicy.MinimumExpanding), arsRow, 1)
        ...
        self.P1defenseWgt.setStyleSheet('border-left: 1px solid green; border-right: 1px solid green; min-width: 125px;')
        ...
        self.P1defenseLayout.addItem(QSpacerItem(0, 30, QSizePolicy.Fixed, QSizePolicy.Fixed), arsRow, 1)
        arsRow += 1
        ...
        for key in self.P1DefenseArray:
            ...
            self.P1defenseLayout.addItem(QSpacerItem(0, 10, QSizePolicy.Fixed, QSizePolicy.Fixed), arsRow, 1)
            arsRow += 1
            ...
            self.P1_armor1_Lbl3 = QLabel('H: ' + str(self.P1DefenseArray[key][0]) + '\nM: ' + str(self.P1DefenseArray[key][1]) + '\nMech: ' + str(self.P1DefenseArray[key][2]))
            ...
            self.P1defenseLayout.addItem(QSpacerItem(0, 40, QSizePolicy.Fixed, QSizePolicy.Fixed), arsRow, 1)
            arsRow += 1
        self.P1defenseLayout.addItem(QSpacerItem(0, 40, QSizePolicy.Fixed, QSizePolicy.MinimumExpanding), arsRow, 1)
        ...
        self.mainLayout.addItem(QSpacerItem(40, 40, QSizePolicy.MinimumExpanding, QSizePolicy.MinimumExpanding), row, colm)
        row += 1
        colm += 1
        ...
        self.mainLayout.addItem(QSpacerItem(0, 30, QSizePolicy.Fixed, QSizePolicy.Fixed), row, 1)
        row += 1
        ...
        self.mainLayout.addItem(QSpacerItem(0, 10, QSizePolicy.Fixed, QSizePolicy.Fixed), row, innerCol)
        row += 1
        ...
        self.mainLayout.addItem(QSpacerItem(0, 20, QSizePolicy.Fixed, QSizePolicy.Fixed), row, innerCol)
        row += 1
        ...
        self.mainLayout.addItem(QSpacerItem(30, 0, QSizePolicy.Fixed, QSizePolicy.Fixed), row, innerCol+3)
        ...
        self.P1Weapon_Pic.setPixmap(QPixmap(self.imageDir + 'sword.jpg').scaledToWidth(50))
        self.mainLayout.addWidget(self.P1Weapon_Pic, row, innerCol)
        
        self.P1Defense_Pic = QLabel("")
        self.P1Defense_Pic.setPixmap(QPixmap(self.imageDir + 'shield.jpg').scaledToWidth(50))
        self.mainLayout.addWidget(self.P1Defense_Pic, row, innerCol+1)
        
        self.P2Weapon_Pic = QLabel("")
        self.P2Weapon_Pic.setPixmap(QPixmap(self.imageDir + 'spear.jpg').scaledToWidth(50))
        self.mainLayout.addWidget(self.P2Weapon_Pic, row, rightCol)
        
        self.P2Defense_Pic = QLabel("")
        self.P2Defense_Pic.setPixmap(QPixmap(self.imageDir + 'gloves.jpg').scaledToWidth(50))
        ...
        self.mainLayout.addItem(QSpacerItem(0, 40, QSizePolicy.Fixed, QSizePolicy.Fixed), row, innerCol)
        row += 1
        
        self.fight_Btn = QPushButton("FIGHT!")
        self.fight_Btn.setStyleSheet("border-radius: 25px; min-width: 150px; height: 50px; background-color: green; color: white; font-size: 36px;")
        ...
        self.mainLayout.addItem(QSpacerItem(40, 40, QSizePolicy.MinimumExpanding, QSizePolicy.MinimumExpanding), row, rightCol+3)
        colm += 1
        ...
        self.P2weaponArsenal.setStyleSheet('border-left: 1px solid green; min-width: 125px;')
        ...
        self.P2WeaponLayout.addItem(QSpacerItem(0, 30, QSizePolicy.Fixed, QSizePolicy.Fixed), arsRow, 1)
        arsRow += 1
        ...
        for key in self.P1WeaponArray:
            ...
            self.P2WeaponLayout.addItem(QSpacerItem(0, 10, QSizePolicy.Fixed, QSizePolicy.Fixed), arsRow, 1)
            arsRow += 1
            ...
            self.P2_weapon1_Lbl3 = QLabel('H: ' + str(self.P2WeaponArray[key][0]) + '\nM: ' + str(self.P2WeaponArray[key][1]) + '\nMech: ' + str(self.P2WeaponArray[key][2]))
            ...
            self.P2WeaponLayout.addItem(QSpacerItem(0, 40, QSizePolicy.Fixed, QSizePolicy.Fixed), arsRow, 1)
            arsRow += 1
        self.P2WeaponLayout.addItem(QSpacerItem(0, 40, QSizePolicy.Fixed, QSizePolicy.MinimumExpanding), arsRow, 1)
        ...
        self.P2defenseArsenal.setStyleSheet('border-left: 1px solid green; border-right: 1px solid green; min-width: 125px;')
        ...
        self.P2defenseLayout.addItem(QSpacerItem(0, 30, QSizePolicy.Fixed, QSizePolicy.Fixed), arsRow, 1)
        arsRow += 1
        ...
        for key in self.P1DefenseArray:
            ...
            self.P2defenseLayout.addItem(QSpacerItem(0, 10, QSizePolicy.Fixed, QSizePolicy.Fixed), arsRow, 1)
            arsRow += 1
            ...
            self.P2_armor1_Lbl3 = QLabel('H: ' + str(self.P2DefenseArray[key][0]) + '\nM: ' + str(self.P2DefenseArray[key][1]) + '\nMech: ' + str(self.P2DefenseArray[key][2]))
            ...
            self.P2defenseLayout.addItem(QSpacerItem(0, 40, QSizePolicy.Fixed, QSizePolicy.Fixed), arsRow, 1)
            arsRow += 1
        self.P2defenseLayout.addItem(QSpacerItem(0, 40, QSizePolicy.Fixed, QSizePolicy.MinimumExpanding), arsRow, 1)
        ...
        self.mainLayout.addItem(QSpacerItem(30, 50, QSizePolicy.Fixed, QSizePolicy.Fixed), row, colm)
    ...
    def AddToQueue(self, action):
        if not len(self.userActionArray) >= 3:
            ...
            self.player1Lineup_Lbl.setText("Action Lineup: " + str(self.userActionArray))
    ...
    def Fight(self):
        if self.fightFlag:
            ...
            if self.compActionArray[0] == 'Defense' and self.userActionArray[0] == 'Defense':
                pass
            else:
