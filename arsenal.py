...
from PySide6.QtWidgets import QLabel, QWidget, QGridLayout, QSpacerItem, QSizePolicy, QPushButton, QApplication, QMainWindow
    ...
    def __init__(self, label='', contents={}):
        ...
        def initUI(self):
            try:
                ...
                #     self.mainLayout.addItem(QSpacerItem(0, 10, QSizePolicy.Fixed, QSizePolicy.Fixed), row, 1)
                #     row += 1
                ...
                #     self.P1_weapon1_Lbl3 = QLabel('H: ' + str(self.contents[item][0]) + '\nM: ' + str(self.contents[item][1]) + '\nMech: ' + str(self.contents[item][2]))
                #     self.P1_weapon1_Lbl3.setStyleSheet("color: white;")
                #     self.mainLayout.addWidget(self.P1_weapon1_Lbl3, row, 1)
                #     row += 1
        
                #     self.mainLayout.addItem(QSpacerItem(0, 40, QSizePolicy.Fixed, QSizePolicy.Fixed), row, 1)
                #     row += 1
...
# window = QMainWindow()
# window.setCentralWidget(Arsenal('Weapons', {'sword': [20, 30, 10], 'spear': [30, 10, 20]}))
