...
class MapScreen(QWidget):
    ...
    def build_map(char: Character) -> "MapScreen":
        ...
        ms.addRoom("Court Yard", (693, 559), test_enemy, "CourtYard")
        ms.addRoom("Commons", (451, 449), test_enemy, "no_texture")
        ms.addRoom("Math", (236, 359), test_enemy, "Physics")
        ms.addRoom("English", (770, 366), test_enemy, "LectureHall")
        ms.addRoom("Science", (490, 217), test_enemy, "Science Lab")
